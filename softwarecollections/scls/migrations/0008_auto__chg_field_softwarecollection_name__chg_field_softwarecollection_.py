...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SoftwareCollection.name'
        db.alter_column('scls_softwarecollection', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SoftwareCollection.slug'
        db.alter_column('scls_softwarecollection', 'slug', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'SoftwareCollection.name'
        db.alter_column('scls_softwarecollection', 'name', self.gf('django.db.models.fields.SlugField')(max_length=100))

        # Changing field 'SoftwareCollection.slug'
        db.alter_column('scls_softwarecollection', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=150))
