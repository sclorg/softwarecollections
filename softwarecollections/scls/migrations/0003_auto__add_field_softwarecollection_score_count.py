...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SoftwareCollection.score_count'
        db.add_column('scls_softwarecollection', 'score_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SoftwareCollection.score_count'
        db.delete_column('scls_softwarecollection', 'score_count')
    ...
    models = {
        ...
        'scls.softwarecollection': {
            ...
            'collaborators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'softwarecollection_set'", 'blank': 'True', 'to': "orm['auth.User']"}),
