...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SoftwareCollection.upstream_url'
        db.add_column('scls_softwarecollection', 'upstream_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SoftwareCollection.upstream_url'
        db.delete_column('scls_softwarecollection', 'upstream_url')
    ...
    models = {
        ...
        'scls.softwarecollection': {
            ...
            'requires': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'required_by'", 'to': "orm['scls.SoftwareCollection']", 'blank': 'True', 'symmetrical': 'False'}),
            ...
            'upstream_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'})
        }
    }
